...
module.exports = function propTypesInstructions(context, components, utils) {
  ...
  function resolveSuperParameterPropsType(node) {
    ...
    issä tahansa selaimessa tai sovelluksessa, jolla on pääsy verkkoon.Yhteytesi ei ole täysin suojattuTämä sivusto käyttää vanhentunutta tietoturvamääritystä, joka voi paljastaa tietosi (esim. salasanat, viestit tai credit-kortit), kun ne lähetetään sivustolle.Tämä sivusto ladattiin TLS 1.0:lla tai TLS 1.1:llä. Ne ovat vanhentuneet ja poistetaan käytöstä tulevaisuudessa. Kun ne poistetaan käytöstä, käyttäjät eivät voi enää ladata tätä sivustoa. Palvelimen pitäisi ottaa käyttöön TLS 1.2 tai uudempi versio.Lomake ei ole suojattuOlet lähettämässä suojaamattomia tietojaKoska lomake lähetetään suojaamattomalla yhteydellä, tietosi näkyvät muille.Lähetä siltiSivusto ei ole turvallinenYhteys sivustoon ($1) ei ole turvallinenNäet tämän varoituksen, koska sivusto ei tue HTTPS:ää. <a href="#" id="learn-more-link">Lue lisää</a>Jatka sivustolleTietokoneLaiteMainoksetmainoksetLisätty todellisuuslisätty todellisuusAutomaattiset latauksetautomaattiset latauksetTaustasynkronointitaustasynkronointiBluetooth-laitteetBluetooth-hakukameraKameran käyttö ja liikekameran käyttö ja liikeleikepöytäevästeet ja sivustodataKolmannen osapuolen sisäänkirjautuminenkolmannen osapuolen sisäänkirjautuminenLaitteesi käyttölaitteesi käyttöJavaScriptsijaintimikrofoniMIDI-laitteetLiiketunnistimetliiketunnistimetNFC-laitteetilmoituksetPonn.ikkunat ja uudelleenohjausponnahdusikkunat ja uudelleenohjausSuojatun sisällön tunnuksetLiike- tai valotunnistimetliike- tai valotunnistimetÄäniääniUSB-laitteetVirtuaalitodellisuusvirtuaalitodellisuusTiedostojen muokkaustiedostojen muokkausfontitProtokollien käsittelijätprotokollien käsittelijätHID-laitteetKuvatkuvatSuojaamaton sisältösuojaamaton sisältöMaksujen käsittelijätmaksujen käsittelijätPDF-dokumentitSarjaportitsarjaportitZoomaustasotzoomaustasotIkkunoiden hallinnointiikkunoiden hallinnointiVahvista puhelinnumerosiKoodisi on $1 ($2)Voit jatkaa osoitteeseen $2 koodilla $1 ($3)englantiranskasaksaitaliajapaniespanjaPalvelin ei voinut todistaa olevansa <strong>$1</strong>; sen suojausvarmenteessa ei määritetä kohteen vaihtoehtoisia nimiä. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.Palvelin ei voinut todistaa olevansa <strong>$1</strong>; sen suojausvarmenne on verkkotunnuksesta <strong>$2</strong>. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.Palvelimen varmenne ei vastaa URL-osoitetta.{1,plural, =1{Palvelin ei voinut todistaa olevansa <strong>{0}</strong>; sen suojausvarmenne vanheni viimeisen päivän aikana. Tämä voi johtua määritysvirheestä tai yhteytesi siepanneesta hyökkääjästä. Tietokoneesi aika on tällä hetkellä {2, date, full}. Onko se oikein? Jos ei, korjaa järjestelmän aika ja päivitä sivu.}other{Palvelin ei voinut todistaa olevansa <strong>{0}</strong>; sen suojausvarmenne on vanhentunut # päivää sitten. Tämä voi johtua määritysvirheestä tai yhteytesi siepanneesta hyökkääjästä. Tietokoneesi aika on tällä hetkellä {2, date, full}. Onko se oikein? Jos ei, päivitä sivu.}}Palvelimen varmenne on vanhentunut.{1,plural, =1{Palvelin ei voinut todistaa olevansa <strong>{0}</strong>; sen suojausvarmenne on päivätty huomiselle. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.}other{Palvelin ei voinut todistaa olevansa <strong>{0}</strong>; sen suojausvarmenne on päivätty # päivää tulevaisuuteen. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.}}Palvelimen varmenne ei ole vielä voimassa.Palvelin ei voinut todistaa olevansa <strong>$1</strong>, sillä sen suojausvarmenne ei tällä hetkellä ole kelvollinen. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.Palvelimen varmenne ei ole tällä hetkellä kelvollinen.Palvelimen varmenne ei ole luotettava.Palvelin ei voinut todistaa olevansa <strong>$1</strong>; sen suojausvarmenne sisältää virheitä. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.Palvelimen varmenteessa on virheitä.Palvelin ei voinut todistaa olevansa <strong>$1</strong>; sen suojausvarmenne ei välttämättä ole voimassa. Tämä voi johtua määritysvirheestä tai verkkoyhteytesi siepanneesta hyökkääjästä.Palvelimen varmennetta ei voi tarkistaa.Kumoamisjärjestelmää ei löytynyt.Yritit yhdistää sivustoon <strong>$1</strong>, mutta varmenteen myöntäjä on kumonnut palvelimen esittäm�